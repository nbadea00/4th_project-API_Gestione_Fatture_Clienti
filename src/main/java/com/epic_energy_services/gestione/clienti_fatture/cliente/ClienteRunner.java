...
public class ClienteRunner implements ApplicationRunner {
    ...
    c1.setCognomeContatto("verdi");
    c1.setDataInserimento(new Date(2023, 3, 4));
    c1.setDataUltimoContatto(null);
    c1.setEmail("verdi@libero.com");
    c1.setEmailContatto("rsossi8@email.com");
    //c1.setFatturatoAnnuale(4.0);
    //c1.setFatture(null);
    //c1.setIndirizzoSedeLegale(null);
    //c1.setIndirizzoSedeOperativa();
    c1.setNomeContatto("lrossi");
    c1.setPartitaIva("ciao3");
    c1.setPec("quattro");
    c1.setRagioneSociale("ciaoo");
    c1.setTelefono("34567");
    c1.setTelefonoContatto("345678");
